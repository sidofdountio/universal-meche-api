...
public class Inventory {
    @Id
    @SequenceGenerator(name = "sequence_id_inventory",allocationSize = 1,sequenceName = "sequence_id_inventory") @GeneratedValue(strategy = SEQUENCE,generator = "sequence_id_inventory")
    private Long id;
